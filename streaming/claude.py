...
# No capability_index here: FS_TOOLS already sends Claude the full tool
# descriptions on the wire, so one-liners would be pure duplication.
_IDENTITY_PROMPT = identity_system_prompt(
    tool_names=[],
