...
FORGE_SYSTEM = (
    ...
    "to a substring. Use for log review; call list_log_sources first.\n"
    ...
    "If the user explicitly asks about pending work, TODOs, logs, or past "
    "conversations, these locations may be useful (do not read them otherwise):\n"
    "- /home/matt/apps/bix-infra/todos/ALL.md — compiled pending TODOs\n"
    "- /home/matt/apps/bix-infra/todos/ — per-project TODO source files\n"
    "- /home/matt/apps/bix-infra/logs/tickets/ — daily log-review tickets\n"
